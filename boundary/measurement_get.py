...
class MeasurementGet (ApiCli):
	...
	# Call our parent to add the default arguments
        ...
        self.parser.add_argument('-d', '--end', dest='end',action='store',metavar="end",help='End of time range')
    ...
    def getArguments(self):
        ...
        self.url_parameters = {"source": self.source, "start": str(startTime) ,"end": str(stopTime), "agg": self.aggregate }
